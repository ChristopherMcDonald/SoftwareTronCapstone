...
\begin{tabular}{|l r|}\hline&\\[-2mm]
	...
	\multicolumn{2}{|p{\textwidth}|}{Description: When sign up button is pressed, user is added with given parameters}\\[1mm]\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Pass/Fail Condition: User inputs are sent to Data Storage}\\[1mm]\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Pre-Conditions: Application UI is running}\\[4mm]
	\multicolumn{2}{|p{\textwidth}|}{Input: User name and user password}\\[2mm]\hline
	\multicolumn{1}{|p{0.49\textwidth}}{Expected Results: Return user parameters }	&\multicolumn{1}{|p{0.45\textwidth}|}{Actual Results: ??}\\\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Post-Conditions: ??}\\\hline 
\end{tabular}
