...
% 62 tests
The testing completed on April 8th, 2018 has yielded ? passes, ? failures, and ? pending. Pending tests have not been executed due to lack of relevance at this stage. The failures in their entirety can be attributed to features that are in progress or that have not yet been implemented including; automated roll and pitch as well as the machine learning model. Given that the failure rate is roughly 17\%, the team does not recommend operation of the project at this time. \\ \\
