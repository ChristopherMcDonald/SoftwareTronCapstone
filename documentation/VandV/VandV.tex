...
\begin{tabular}{|l r|}\hline&\\[-2mm]
	...
	\multicolumn{2}{|c|}{\textbf{\large{Sends Hit Signal to SmartServe}}}\\&\\\hline&\\[-3mm]
...
\tiny{SMC1}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{SMC2}&\tiny{X}&\tiny{X}&&&\tiny{X}&&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{SMC3}&\tiny{X}&&&\tiny{X}&&&&&&&&&&&&&& \\ \hline
\tiny{SMC4}&\tiny{X}&&&&&&&&&&&&&&&&& \\ \hline
\tiny{SMC5}&\tiny{X}&&\tiny{X}&&&&&&&&&&&&&&& \\ \hline
\tiny{CV1}&&&&&\tiny{X}&&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{CV2}&&&&&\tiny{X}&&&&&&&&&&&&& \\ \hline
\tiny{CV3}&&&&&\tiny{X}&&&&&&&&&&&&& \\ \hline
\tiny{CV4}&&&&&\tiny{X}&&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{CV5}&&&&&\tiny{X}&&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{CV6}&&&&&&\tiny{X}&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{CV7}&&&&&\tiny{X}&&&&&&&&&&&&& \\ \hline
\tiny{CV8}&&&&&\tiny{X}&&&&&&&&&&&&& \\ \hline
\tiny{CV9}&&&&&\tiny{X}&&&&&&&&&&&&& \\ \hline
\tiny{CV10}&&&&&&\tiny{X}&&&&&&&&&&&& \\ \hline
\tiny{SR1}&&&&&&&&&&&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\tiny{SR2}&&&&&&&\tiny{X}&&&&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\tiny{SR3}&&&&&&&&&&&&&&&&&& \\ \hline
\tiny{SR4}&&&&&&&&&&&&&&\tiny{X}&&&& \\ \hline
\tiny{SR5}&&&&&&&&&&&&&&\tiny{X}&&&& \\ \hline
\tiny{SM1}&\tiny{X}&&\tiny{X}&&\tiny{X}&&&&&&&&&&&&& \\ \hline
\tiny{SM2}&\tiny{X}&\tiny{X}&&&\tiny{X}&&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{SM3}&&&&&&&&&&&&&&&&&& \\ \hline
\tiny{DS1}&&&&&&&&\tiny{X}&&&&&&&&&& \\ \hline
\tiny{DS2}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{DS3}&&&&&&\tiny{X}&&&&&&&&&&&& \\ \hline
\tiny{DS4}&&&&&&&&&\tiny{X}&&&&&&&&& \\ \hline
\tiny{UI1}&&&&&&&&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&&&\tiny{X}&\tiny{X}& \\ \hline
\tiny{UI2}&&&&&&&&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&&&\tiny{X}&\tiny{X}& \\ \hline
\tiny{UI3}&&&&&&&&&&&&&&&&\tiny{X}&& \\ \hline
\tiny{UI4}&&&&&&&&\tiny{X}&&&&&&&&&& \\ \hline
\end{tabular}
\end{table}
...
\multicolumn{19}{|c|}{\textbf{Functional Requirement-Test Matrix}}                          \\ \hline
 & \tiny{F1} & \tiny{F2} & \tiny{F3} & \tiny{F4} & \tiny{F5} & \tiny{F6} & \tiny{F7} & \tiny{F8} & \tiny{F9} & \tiny{F10} & \tiny{F11} & \tiny{F12} & \tiny{F13} & \tiny{F14} & \tiny{F15} & \tiny{F16} & \tiny{F17} & \tiny{F18} \\ \hline
\tiny{SS1}&&&&&&&\tiny{X}&&&&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\tiny{SS2}&&&&&&&\tiny{X}&&&&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\tiny{SS3}&&&&&&&&&&&&&&&&&& \\ \hline
\tiny{SS4}&&&&&&&&&&&&&&\tiny{X}&&&& \\ \hline
\tiny{SS5}&&&&&&&&&&&&&&&\tiny{X}&&& \\ \hline
\tiny{SS6}&&&&&&&&&&&&&&\tiny{X}&&&& \\ \hline
\tiny{SS7}&&&&&&&&&&&&&&\tiny{X}&&&& \\ \hline
\tiny{SS8}&&&&&\tiny{X}&\tiny{X}&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{SS9}&&&&&\tiny{X}&\tiny{X}&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{SS10}&&&&&\tiny{X}&\tiny{X}&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{SS11}&&&&&\tiny{X}&\tiny{X}&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{SS12}&&&&&&\tiny{X}&&\tiny{X}&\tiny{X}&&&&\tiny{X}&&&&&\tiny{X} \\ \hline
\tiny{SS13}&&&&&&\tiny{X}&&\tiny{X}&\tiny{X}&&&&\tiny{X}&&&&&\tiny{X} \\ \hline
\tiny{SS14}&&&&&&&&\tiny{X}&&&&&&&&&& \\ \hline
\tiny{SS15}&&&&&&\tiny{X}&&&&&&&&&&&& \\ \hline
\tiny{SS16}&&&&&&&&&\tiny{X}&&&&&&&&& \\ \hline
\tiny{SS17}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{SS18}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{SS19}&\tiny{X}&&\tiny{X}&&&&&&&&&&&&&&& \\ \hline
\tiny{SS20}&\tiny{X}&&\tiny{X}&&&&&&&&&&&&&&& \\ \hline
\tiny{SS21}&\tiny{X}&\tiny{X}&&&\tiny{X}&&&&&&&&&&&&&\tiny{X} \\ \hline
\tiny{SS22}&\tiny{X}&\tiny{X}&&&\tiny{X}&&&&&&&&&&&&&\tiny{X} \\ \hline
\end{tabular}
\end{table}
...
\tiny{SMC1}&&&&&&&&&&&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\tiny{SMC2}&&&&&&&&&&&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\tiny{SMC3}&&&&&&&&&&&&&&\tiny{X}&&&& \\ \hline
\tiny{SMC4}&&&&&&&&&&&&&&\tiny{X}&&&& \\ \hline
\tiny{SMC5}&&&&&&&&&&&&&&\tiny{X}&&&& \\ \hline
\tiny{CV1}&&&&&&&&\tiny{X}&&&&&&&&&& \\ \hline
\tiny{CV2}&&&&&&&&&&&&&&&&&& \\ \hline
\tiny{CV3}&&&&&&&&&&&&&&&&&& \\ \hline
\tiny{CV4}&&&&&&&&&&&&&&&&&& \\ \hline
...
\tiny{SR5}&&&&&&&&&&&&&&&&&& \\ \hline
\tiny{SM1}&&&&&&&&&&&&&&\tiny{X}&&&& \\ \hline
\tiny{SM2}&&&&&&&&&&&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\tiny{SM3}&&&&&&&&&&&&&&\tiny{X}&&&& \\ \hline
\tiny{DS1}&&&&&&\tiny{X}&&&&\tiny{X}&&&&&&&& \\ \hline
\tiny{DS2}&&&&&&&&&&&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\tiny{DS3}&&&&&\tiny{X}&&&&&&&&&&&&& \\ \hline
\tiny{DS4}&&&&&&&&&&&&&&&&&& \\ \hline
\tiny{UI1}&\tiny{X}&\tiny{X}&\tiny{X}&&\tiny{X}&\tiny{X}&\tiny{X}&&\tiny{X}&\tiny{X}&&\tiny{X}&&&&&& \\ \hline
\tiny{UI2}&\tiny{X}&\tiny{X}&\tiny{X}&\tiny{X}&&&&&&&&&&&&&& \\ \hline
\tiny{UI3}&&&\tiny{X}&\tiny{X}&&&&&&&&&&&&&& \\ \hline
\tiny{UI4}&&&\tiny{X}&&&\tiny{X}&&&&\tiny{X}&&&&&&&& \\ \hline
\end{tabular}
\end{table}
...
\tiny{SS10}&&&&&&&&&&&&&&&&&& \\ \hline
\tiny{SS11}&&&&&&&&&&&&&&&&&& \\ \hline
\tiny{SS12}&&&&&\tiny{X}&\tiny{X}&&&&\tiny{X}&&&&&&&& \\ \hline
\tiny{SS13}&&&&&\tiny{X}&\tiny{X}&&&&\tiny{X}&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\tiny{SS14}&&&&&&\tiny{X}&&&&\tiny{X}&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\tiny{SS15}&&&&&\tiny{X}&&&&&&&&&&&&& \\ \hline
\tiny{SS16}&&&&&&&&&&&&&&&&&& \\ \hline
\tiny{SS17}&&&&&&&&&&&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\tiny{SS18}&&&&&&&&&&&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\tiny{SS19}&&&&&&&&&&&&&&\tiny{X}&&&& \\ \hline
\tiny{SS20}&&&&&&&&&&&&&&\tiny{X}&&&& \\ \hline
\tiny{SS21}&&&&&&&&&&&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\tiny{SS22}&&&&&&&&&&&&&&\tiny{X}&\tiny{X}&&& \\ \hline
\end{tabular}
\end{table}
