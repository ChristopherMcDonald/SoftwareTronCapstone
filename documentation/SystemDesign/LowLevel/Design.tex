...
\begin{figure}[H]
  ...
  \begin{minipage}[b]{0.4\textwidth}
    ...
    \caption{Shaft Adapter Model}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth]{img/2.jpg}
    \caption{Shaft Adapter Draft}
  \end{minipage}
\end{figure}
\end{minipage}
\end{center}
...
\begin{figure}[H]
  ...
  \begin{minipage}[b]{0.4\textwidth}
    ...
    \caption{Panning Control Assembly}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth]{img/4.jpg}
    \caption{Exploded Worm Attachment}
  \end{minipage}
\end{figure}
\end{minipage}
\end{center}
...
\begin{figure}[H]
  ...
  \begin{minipage}[b]{0.2\textwidth}
    ...
    \caption{Motor Bracket Assembly}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.2\textwidth}
...
\begin{figure}[H]
  ...
  \begin{minipage}[b]{0.4\textwidth}
    ...
    \caption{Roll Control Model}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth]{img/12.jpg}
    \caption{Roll Control Draft}
  \end{minipage}
\end{figure}
\end{minipage}
\end{center}
...
\begin{figure}[H]
  ...
  \begin{minipage}[b]{0.4\textwidth}
    ...
    \caption{Supports and Base}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth]{img/14.jpg}
    \caption{Bucket Assembly}
  \end{minipage}
\end{figure}
\end{minipage}
\end{center}
...
\begin{figure}[H]
  ...
  \begin{minipage}[b]{0.4\textwidth}
    ...
    \caption{Outside View Pitch Control}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth]{img/16.jpg}
    \caption{Inside View Pitch Control}
  \end{minipage}
\end{figure}
\end{minipage}
\end{center}
...
\begin{figure}[H]
  ...
  \begin{minipage}[b]{0.4\textwidth}
    ...
    \caption{Gear Stepper Motor with Driver}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth]{img/18.jpg}
    \caption{Japan Servo Stepper Motor}
  \end{minipage}
\end{figure}
\end{minipage}
\end{center}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\textwidth]{img/21.jpg} %requires the graphicx package
	\caption{Complete Hardware Assembly}
\end{figure}
...
\begin{sidewaysfigure}[ht]
   \centering
   \includegraphics[width=1.1\textwidth]{diagram/DCD.png} % requires the graphicx package
