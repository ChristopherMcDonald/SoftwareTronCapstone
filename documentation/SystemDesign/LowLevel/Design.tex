...
\textbf{Secrets} \\ 
?????? - Help, what's the secret for an ADT? \\  \\
\textbf{MID} 
\begin{itemize}
...
\item \textbf{Send} -  \\ returns: \textit{none} \\ description: Sends a signal to Smartserve indicating that a successful return was made
\end{itemize}
