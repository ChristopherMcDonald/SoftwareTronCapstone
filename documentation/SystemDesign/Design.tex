...
% ask Nick about lines, predicted abnormal behaviour, computer vision FSM to detect returns, UI, ask Nick about need 3D model, CRC card formatting, add Shot Opt requirement, add electric schematic
...
To finish the document, each subsystem will be responsible for implementing some set of requirements which can be found \href{../Requirements/Requirements.pdf}{here}. These requirements are outlined in the requirements document found here.
