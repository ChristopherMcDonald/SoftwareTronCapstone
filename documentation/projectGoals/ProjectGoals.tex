...
\item The system can hit each square of a 3x3 grid with an accuracy of 75\%
\item The system implements reinforcement learning algorithms
\item The system can provide insightful feedback to the user
\item The system is implemented with one camera
\item The shooting mechanism can pan
\item The shooting mechanism can shoot at various speeds
\end{itemize}
...
\begin{itemize}
\item The system can hit each square of a 6x6 grid with an accuracy of 75\%
