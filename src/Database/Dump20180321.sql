...
INSERT INTO `user` VALUES (25,'Sharon','plzwork'),(26,'Sharon','plzwork'),(35,'Sharon','SharonPassword'),(36,'Harit','HaritPassword'),(37,'Nish','NishPassword'),(38,'Sam','SamPassword'),(39,'Jared','JaredPassword'),(40,'Chris','ChrisPassword'),(41,'Janak','JanakPassword');
...
BEGIN
	set @sql = concat(
		'SELECT zone.zone_id, omega.velocity, omega.angle, return_rate.returned, return_rate.time_stamp
        FROM shot_type
		JOIN omega ON shot_type.omega_id = omega.omega_id
        JOIN zone ON shot_type.zone_id = zone.zone_id
		JOIN return_rate ON shot_type.shot_id = return_rate.shot_id

		WHERE 	(return_rate.user_id = ',user_id_input,') AND
				(return_rate.shot_id IN (' , zones_input , '0)) AND
				(omega.velocity BETWEEN ',velocity_initial,' AND ',velocity_final,') AND
				(omega.angle BETWEEN ',angle_initial,' AND ',angle_final,') AND
				(return_rate.time_stamp BETWEEN "',date_initial,'" AND "',date_final,'")'
...
-- Dump completed on 2018-03-21  8:44:56
