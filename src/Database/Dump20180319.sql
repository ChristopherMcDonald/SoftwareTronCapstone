...
INSERT INTO `return_rate` VALUES (25,1,1,'1969-12-31 07:00:00'),(25,1,1,'1969-12-31 07:00:00'),(25,1,1,'1969-12-31 07:00:00'),(25,1,1,'1969-12-31 07:00:00'),(26,1,1,'2018-02-26 11:05:00'),(26,1,1,'2018-02-26 11:05:00'),(25,1,1,'2018-03-10 02:00:20'),(25,1,1,'2018-03-10 02:01:37');
...
INSERT INTO `user` VALUES (11,'user','hello'),(12,'44','Harit'),(13,'44','Harit'),(14,'44','Harit'),(15,'44','Harit'),(16,'44','Harit'),(17,'tseting','Sharon'),(18,'Sharon','plzwork'),(19,'Sharon','plzwork'),(20,'Sharon','plzwork'),(21,'Sharon','plzwork'),(22,'Sharon','plzwork'),(23,'Sharon','plzwork'),(24,'Sharon','plzwork'),(25,'Sharon','plzwork'),(26,'Sharon','plzwork'),(27,'Sharon','plzwork'),(28,'Sharon','plzwork'),(29,'Sharon','apples'),(30,'Sharon','apples'),(31,'Sharon','march10'),(32,'testing@march11.com','pass'),(33,'glenne.gr@gmail.com','fergie');
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `statistics`(
    ...
    OUT zone_out int,
    OUT velocity_out double,
    OUT angle_out double,
    OUT returned_out boolean,
    OUT date_out datetime
)
BEGIN

    PREPARE stmt FROM 
		"SELECT zone.zone_id, omega.velocity, omega.angle, return_rate.returned, return_rate.time_stamp
        INTO @zone_out, @velocity_out, @angle_out, @returned_out, @date_out 
        FROM shot_type
		JOIN omega ON shot_type.omega_id = omega.omega_id
        JOIN zone ON shot_type.zone_id = zone.zone_id
		JOIN return_rate ON shot_type.shot_id = return_rate.shot_id

		WHERE 	(return_rate.user_id = ?) AND
				(return_rate.shot_id IN (?,0)) AND
				(omega.velocity BETWEEN ? AND ?) AND
				(omega.angle BETWEEN ? AND ?) AND
				(return_rate.time_stamp BETWEEN ? AND ?)"
	...
	SELECT @zone_out, @velocity_out, @angle_out, @returned_out, @date_out;
...
-- Dump completed on 2018-03-19 19:20:46
