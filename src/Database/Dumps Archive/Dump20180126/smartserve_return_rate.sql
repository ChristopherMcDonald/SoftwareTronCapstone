...
CREATE TABLE `return_rate` (
  ...
  `shot_id` varchar(255) DEFAULT NULL,
  `returned` varchar(255) DEFAULT NULL,
  `time_stamp` varchar(255) DEFAULT NULL,
  KEY `user_id` (`user_id`),
  KEY `shot_id` (`shot_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='user_id should be INT(11)\nshot_id should be INT(11)\nreturned should be TINYINT(1)\ntime_stamp should be DATETIME';
...
INSERT INTO `return_rate` VALUES ('Hi','5','true','jan26');
...
-- Dump completed on 2018-01-26 17:07:30
